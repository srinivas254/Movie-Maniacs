...
export function PublicUserProfileCard() {
  ...
  if (!profile) {
    return (
      <div className="bg-black/60 backdrop-blur-md border border-white/10 p-6 rounded-xl w-80 h-fit flex items-center justify-center text-gray-400 text-sm">
        Loading...
      </div>
    );
  }
  ...
  return (
    <div className="bg-black/60 backdrop-blur-md border border-white/10 p-6 rounded-xl w-80 h-fit shrink-0">
      {profile.pictureUrl ? (
        <img
